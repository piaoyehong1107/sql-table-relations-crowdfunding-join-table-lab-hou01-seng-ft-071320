...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT projects.category, pledges.amount FROM projects LEFT OUTER JOIN pledges ON projects.id=pledges.project_id  WHERE projects.category='music'ORDER BY users.name"
end
